...
/**
	This class performs the "Clear Cart" business process
*/
public class PClearCart extends UIProcess {
	
	public PClearCart(String category, String name, String description){
